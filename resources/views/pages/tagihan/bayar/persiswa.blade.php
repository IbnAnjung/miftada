...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item active"><a href="#">per-siswa</a></div>
    </div>
  </div>

  <div class="section-body">
    <div class="section-title">FORM PEMBAYARAN TAGIHAN PER-SISWA</div>
        ...
        <form class="form-horizontal row">
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-5">
                        <select name="siswa" id="siswa" class="form-control"></select>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <select name="tagihan" id="tagihan" class="form-control" multple></select>
                    </div>
                </div>
