  ...
  <div class="section-body">
    <div class="card card-warning">
      <div class="card-header">
        <h4>Daftar Kelas Non Aktif</h4>
        <div class="card-header-action">
            <a href="{{ route('kelas.index') }}" class="btn btn-success">
                <i class="fa fa-home"></i> Kelas Aktif
            </a>
        </div>
      </div>
      <div class="card-body">
        <div class="table-responsive">
            <table class="table table-striped table-hover" id="table-master-kelas-nonaktif">
                <thead>
                    <tr>    
                        <th>Tingkat</th>
                        <th>Nama Kelas</th>
